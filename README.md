# Colorable Cozy Lights ( Lethal Company 💵 )
...
Hi! My mod is open source for: https://thunderstore.io/c/lethal-company/p/AtomicStudio/Colorable_CozyLights/

This changes the cozy lights on the ship to be any color! Uses BepInEx.
